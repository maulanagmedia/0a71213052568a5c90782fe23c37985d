package gmedia.net.id.pspreseller.HomePreorderPerdana;
...
public class ListBarangPreorder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_barang_preorder);
        ...
        setTitle("Pilih Perdana Preorder");
